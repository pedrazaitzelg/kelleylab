...
genome_dir=/hb/groups/kelley_training/itzel/data/genomic/${species}
...
if [ -f ${sra_acc}_Log.final.out ]; then
    ...
    rm -r *
    STAR --genomeDir ../.. --runThreadN 1 --outFilterMultimapNmax 1 --twopassMode Basic --sjdbGTFfile ${genome_dir}/genomic.gff \
