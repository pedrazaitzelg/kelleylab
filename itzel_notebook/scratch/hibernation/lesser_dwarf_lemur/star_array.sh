...
trimmed_dir=/hb/groups/kelley_training/itzel/anne/hibernation/data/transcriptomic/${species}/${tissue}
...
if [ -f ${sra_acc}_Log.final.out ]; then
    ...
    STAR --genomeDir /hb/groups/kelley_training/itzel/data/genome/$species}/index_star_out --runThreadN 4 --outFilterMultimapNmax 1 --twopassMode Basic --sjdbGTFfile ${genome_dir}/genomic.gff \
