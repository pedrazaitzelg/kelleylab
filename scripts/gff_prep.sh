...
### add orthogroup info to the gff file
python2 ~/kelleylab_rotation/scripts/blairs_gff_scripts/annotateGFF.py ${gff_file} ${og_dir}/Orthogroups.${species}.tsv ${species}.OG.gff
