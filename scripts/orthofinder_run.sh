...
#SBATCH --partition=256×44               # Partition/queue to run on
...
#SBATCH --cpus-per-task=44               # Number of CPU cores to use per task
#SBATCH --mem=256G                       # Ammount of RAM to allocate for the task
...
orthofinder -f ExampleData -t 44 -a 5 -M msa -A mafft -T fasttree -o ExampleData_out -S diamond_ultra_sens
